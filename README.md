...
> 👉 **Non sei uno sviluppatore?** Leggi la [GUIDA_RAPIDA.md](GUIDA_RAPIDA.md) oppure apri la [pagina Setup interattiva](https://https://github.com/Giammariodecandia1/grigliatron/setup.html) per creare la tua copia in 20 minuti senza scrivere una riga di codice.
...
2. **⚙️ [Apri la pagina Setup interattiva](https://https://github.com/Giammariodecandia1/grigliatron/setup.html)** — Mini configuratore che ti genera i nomi e i testi pronti da copiare.
